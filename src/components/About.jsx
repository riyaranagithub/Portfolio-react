function About() {
  return (
    <>
      <h1 className='text-center text-4xl text-blue-500 font-Poppins font-semibold mt-20'>About Me</h1>
      <div className='w-full h-auto md:h-screen flex flex-col md:flex-row justify-center items-center p-4'>
        <div className='w-full md:w-1/2 h-64 md:h-full bg-cover' style={{ backgroundImage: 'url("./src/animation.gif")' }}></div>
